...
const CommentModel = new Comment_1.default().getModelForClass(
  Comment_1.default
);
// API for testing
...
router.post('/move', (req, res) => {
  ...
  (() =>
    __awaiter(this, void 0, void 0, function*() {
      yield CardModel.findOneAndUpdate(
        { _id },
...
router.get('/:_id/comments', (req, res) => {
  ...
  (() =>
    __awaiter(this, void 0, void 0, function*() {
      var thisCard = yield CardModel.find({ _id }).populate(
        'ownerId',
        'username imageUrl'
      );
      thisCard = thisCard[0];
      var comments = yield CommentModel.find({ cardId: _id })
