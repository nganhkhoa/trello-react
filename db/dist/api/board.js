  ...
  (() =>
    __awaiter(this, void 0, void 0, function*() {
      ...
      if (modeView !== null && modeView !== undefined)
        obj['modeView'] =
          String(modeView).toLowerCase() == 'true' ? true : false;
...
router.get('/:_id/lists', (req, res) => {
  ...
  (() =>
    __awaiter(this, void 0, void 0, function*() {
      ...
      var members = yield UserModel.find(
        { _id: { $in: thisBoard.members } },
        { username: 1, imageUrl: 1 }
      );
      thisBoard.members = members;
      var lists = yield ListModel.find({ boardId: _id }).sort({
        dateCreate: 1
      });
      for (let l of lists) {
        var cards = yield CardModel.find({ listId: l._id })
